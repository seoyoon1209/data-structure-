...
static void ensure_cap(ArrBT *t, size_t need)
{
    ...
    if (ncap > t->cap)
        memset(na + t->cap, 0, ncap - t->cap); // 확장 영역 0으로 초기화
